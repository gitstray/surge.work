...
<?php
						...
						$to = "surge@goblazon.com";		/* YOUR EMAIL HERE */
						$subject = "Quotation from Surge.Work";
						$headers = "From: Quotation from Surge.Work <noreply@goblazon.com>";
						$message = "DETAILS\n";
						...
						$userheaders = "From: surge@goblazon.com\n";
